...
app.post('/abiturs', 
    [
        ...
        body('gender')
            .notEmpty()
            .isIn(['0','1'])
            .withMessage('гендер только 0 или 1')
    ],
    (req, res) => { // http://localhost:3000/abiturs
        ...
        // https://express-validator.github.io/docs/6.15.0/matched-data-api
        // let data = matchedData(req, { locations: ['body'] }); // это те поля, которые проверены
